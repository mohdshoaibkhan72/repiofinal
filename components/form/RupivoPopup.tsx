  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-full items-center justify-center p-4 text-center">
        <div
          className={`relative w-full max-w-[420px] transform rounded-[16px] bg-white p-5 sm:p-6 text-left shadow-[0_12px_32px_rgba(0,0,0,0.12)] transition-all duration-300 ease-out my-8 ${
