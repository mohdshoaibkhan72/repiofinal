...
export const ContactUs: React.FC = () => {
  ...
  return (
    <PageLayout title="Contact Us" subtitle="We're here to help you 24/7. Reach out to us through any channel." maxWidth="max-w-[1200px]">
            ...
            <div className="space-y-6">
              <div className="flex items-start p-6 bg-blue-50/50 rounded-2xl border border-blue-100 hover:bg-blue-50 transition-colors group cursor-default">
                ...
                <div>
                  ...
                  <p className="text-rupivo-blue font-bold">support@rupivo.com</p>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl border border-gray-100 hover:border-rupivo-blue/30 transition-colors">
                  ...
                  <p className="text-sm font-medium text-rupivo-blue">partner@rupivo.com</p>
                </div>
                <div className="p-4 rounded-xl border border-gray-100 hover:border-rupivo-blue/30 transition-colors">
                  <p className="text-xs font-bold text-gray-400 uppercase">Media / Press</p>
                  <p className="text-sm font-medium text-rupivo-blue">media@rupivo.com</p>
                </div>
                <div className="p-4 rounded-xl border border-gray-100 hover:border-rupivo-blue/30 transition-colors">
                  <p className="text-xs font-bold text-gray-400 uppercase">Legal / Privacy</p>
                  <p className="text-sm font-medium text-rupivo-blue">legal@rupivo.com</p>
                </div>
                <div className="p-4 rounded-xl border border-gray-100 hover:border-rupivo-blue/30 transition-colors">
                  <p className="text-xs font-bold text-gray-400 uppercase">Careers</p>
                  <p className="text-sm font-medium text-rupivo-blue">careers@rupivo.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-gray-200 shadow-xl shadow-gray-200/50">
            ...
            {status === 'success' ? (
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6 text-center">
                ...
                <p className="text-green-700 mb-4">Thanks for reaching out. We'll get back to you shortly.</p>
                <Button onClick={() => setStatus('idle')} variant="outline" className="mx-auto">Send another</Button>
              </div>
            ) : (
              <form className="space-y-5" onSubmit={handleSubmit}>
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      required
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-rupivo-blue/20 focus:border-rupivo-blue outline-none transition-all"
                      placeholder="Rahul"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    required
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-rupivo-blue/20 focus:border-rupivo-blue outline-none transition-all resize-none"
                    placeholder="How can we help you?"
                  ></textarea>
                </div>
                <Button fullWidth type="submit" disabled={status === 'submitting'} className="rounded-xl mt-2 h-14 font-bold text-lg">
...
export const FAQs: React.FC = () => {
  ...
  return (
    <PageLayout title="Frequently Asked Questions" subtitle="Find answers to common queries about Rupivo." maxWidth="max-w-[1200px]">
