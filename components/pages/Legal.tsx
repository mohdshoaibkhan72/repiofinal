...
export const PrivacyPolicy: React.FC = () => (
    <PageLayout title="Privacy Policy" subtitle="Last updated: March 2024" maxWidth="max-w-[1200px]">
        <div className="space-y-16">
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
                ...
                <div className="flex gap-4 items-center mt-6">
                    <a href="mailto:privacy@rupivo.com" className="bg-rupivo-dark text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-rupivo-blue transition-colors">Contact Privacy Officer</a>
                </div>
            </section>
        </div>
    </PageLayout>
...
export const TermsAndConditions: React.FC = () => (
    <PageLayout title="Terms & Conditions" subtitle="Please read carefully before using our services." maxWidth="max-w-[1200px]">
...
export const GrievanceRedressal: React.FC = () => (
    <PageLayout title="Grievance Redressal" subtitle="We are committed to resolving your concerns quickly and fairly." maxWidth="max-w-[1200px]">
        <div className="space-y-16">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-xl shadow-blue-900/5 relative hover:-translate-y-1 transition-transform">
                        ...
                        <div className="space-y-4 text-center border-t border-gray-50 pt-6">
                            <div>
                                ...
                                <p className="text-gray-800 font-medium">support@rupivo.com</p>
                            </div>
                            <div>
                    ...
                    <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-xl shadow-blue-900/5 relative hover:-translate-y-1 transition-transform">
                        ...
                        <div className="space-y-4 text-center border-t border-gray-50 pt-6">
                            ...
                            <div>
                                <p className="text-xs text-gray-400 font-bold uppercase">Email</p>
                                <p className="text-rupivo-green font-medium">grievance@rupivo.com</p>
                            </div>
