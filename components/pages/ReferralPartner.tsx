                        ...
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center lg:justify-start gap-4 mb-12">
                                ...
                                <Button
                                    ...
                                    onClick={() => openComingSoon("Our Partner App is coming soon!")}
                                >
                                    Download App
                                </Button>
                            </div>
                        ...
                        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="bg-white p-8 md:p-10 rounded-[2rem] text-gray-800 shadow-xl relative">
                                <form className="space-y-5" onSubmit={handleRegisterSubmit}>
                                    ...
                                    <Button type="submit" fullWidth className="h-16 text-lg rounded-xl mt-6 shadow-lg shadow-rupivo-blue/30 hover:shadow-xl hover:-translate-y-1 transition-all" disabled={submitting}>
