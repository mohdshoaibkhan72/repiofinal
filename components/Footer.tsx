          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="md:w-3/4">
              ...
              <p className="text-xs text-gray-500 leading-relaxed text-justify">
                RUPIVO (Aethos Fintech Private Limited) is a Digital Lending Platform/Loan Service Provider (LSP) that acts as a bridge between borrowers and RBI-registered NBFCs. We are not a bank or a lender. All loan approvals, disbursements, and recovery are handled by our regulated lending partners. We strictly adhere to the RBI's Digital Lending Guidelines (2022).
              </p>
              <div className="mt-3 flex flex-wrap gap-4 text-xs text-gray-400 font-medium">
                <span>CIN: U72900UP2021PTC154496</span>
                <span>•</span>
            ...
            <div className="md:w-1/4 flex flex-col justify-center border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
              ...
              <p className="text-xs text-gray-600">Mr. Amjad Khan </p>
              <p className="text-xs text-rupivo-blue font-bold mt-1">grievance@rupivo.com</p>
